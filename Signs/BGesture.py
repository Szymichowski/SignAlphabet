...
class BGestureDetector(BaseGesture):
    def __init__(self):
        super().__init__()
    ...
    def is_a_gesture(self, landmarks):
        ...
        if thumb_tip.y < index_finger_tip.y and thumb_tip.y < middle_finger_tip.y and thumb_tip.y < ring_finger_tip.y and thumb_tip.y < pinkie_finger_tip.y and thumb_tip.x < index_finger_tip.x and thumb_tip.x < middle_finger_tip.x:
            return True
        else:
            return False
...
def main():
    ...
    a_gesture_detector = BGestureDetector()
    ...
    window = sg.Window('B Gesture Detection', layout, finalize=True, resizable=True)
